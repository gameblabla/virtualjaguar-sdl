...
void LoadVJSettings(void)
{
	...
	*/
	...
	if (vjs.DSPEnabled != true || vjs.DSPEnabled != false) vjs.DSPEnabled = sdlemu_getval_bool("DSPEnabled", true);
	...
	vjs.p1KeyBindings[4] = sdlemu_getval_int("p1k_c", SDLK_LCTRL);
	vjs.p1KeyBindings[5] = sdlemu_getval_int("p1k_b", SDLK_LALT);
	vjs.p1KeyBindings[6] = sdlemu_getval_int("p1k_a", SDLK_LSHIFT);
	vjs.p1KeyBindings[7] = sdlemu_getval_int("p1k_option", SDLK_ESCAPE);
	vjs.p1KeyBindings[8] = sdlemu_getval_int("p1k_pause", SDLK_RETURN);
	vjs.p1KeyBindings[9] = sdlemu_getval_int("p1k_0", SDLK_SPACE);
	vjs.p1KeyBindings[10] = sdlemu_getval_int("p1k_1", SDLK_TAB);
	vjs.p1KeyBindings[11] = sdlemu_getval_int("p1k_2", SDLK_BACKSPACE);
